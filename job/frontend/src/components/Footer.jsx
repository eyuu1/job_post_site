...
const footer = () => {
  return (
    <div className='md:h-[220px] md:bg-[#035956] flex sm:flex-col md:flex-row justify-between items-center sm:mt-8 md:mt-16 leading-10 md:text-white sm:px-20 md:px-36'>
        <div>
